...
const SideMenu = ({ isOpen, closeMenu }: SideMenuProps) => (
  <div
    className={`fixed top-0 left-0 h-screen w-2/3 bg-red-500 text-white transform transition-transform 
      duration-300 ease-in-out md:hidden shadow-lg ${isOpen ? "translate-x-0" : "-translate-x-full"}`}>
